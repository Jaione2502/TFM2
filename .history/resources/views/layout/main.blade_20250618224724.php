...
<body>
    ...
    @vite(['resources/js/recetaspopularesindex.js'])

    @vite(['resources/css/general.css'])
    @vite(['resources/css/cabecerapie.css'])
    @vite(['resources/css/modooscuro.css'])
    @vite(['resources/css/landingpage.css'])
    @vite(['resources/css/recetaspopulares.css'])
    @vite(['resources/css/detalle.css'])
